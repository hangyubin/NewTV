...
const ImagePlaceholder = ({ aspectRatio, className }: { aspectRatio: string; className?: string }) => (
  <div
    className={`w-full ${aspectRatio} rounded-lg transition-all duration-300 ${className || ''}`}
    style={{
      background:
