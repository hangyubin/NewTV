  ...
  forwardRef<HTMLDivElement, VideoCardCoreProps>(function VideoCardCore(
    ...
    return (
      ...
      >
        {/* 海报容器 */}
        <div
          className={`relative aspect-[2/3] overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800 transition-all duration-400 ease-in-out group-hover:shadow-2xl group-hover:shadow-black/30 dark:group-hover:shadow-black/40 glass ${origin === 'live' ? 'ring-1 ring-gray-300/80 dark:ring-gray-600/80' : ''}`}
          style={{
            WebkitUserSelect: 'none',
            userSelect: 'none',
            WebkitTouchCallout: 'none',
            ...
            >
              ...
              {config.showHeart && (
                <svg
                  ...
                  strokeLinecap='round'
                  strokeLinejoin='round'
                  className={`transition-all duration-300 ease-out hover:scale-[1.1] ${!favorited ? 'hover:stroke-red-400' : ''}`}
                  style={{
                    WebkitUserSelect: 'none',
                    userSelect: 'none',
                    WebkitTouchCallout: 'none',
                      ...
                      <div className='mt-1 sm:mt-2 pt-1 sm:pt-1.5 border-t border-gray-600/70'>
                        <div className='flex items-center justify-center'>
                          <span className='text-[10px] sm:text-xs font-medium'>
                            +{Array.from(new Set(source_names)).length - 6} 播放源
                          </span>
                        </div>
                      </div>
                    )}
