    ...
    return (
      <>
        ...
        >
          {/* 海报容器 */}
          <div
            className={`relative aspect-[3/4] overflow-hidden rounded-t-lg bg-gray-100 dark:bg-gray-800 transition-all duration-300 ease-in-out group-hover:shadow-apple-lg group-hover:shadow-black/20 dark:group-hover:shadow-black/20 ${
              origin === 'live'
