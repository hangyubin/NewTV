    ...
    const CellComponent = useCallback(
      ({
        ...
        if (cellViewMode === 'agg') {
          ...
          // 获取相同标题的统计信息
          const sameTitleStats = cellSameTitleStatsMap
            ? cellSameTitleStatsMap.get(`${searchItem.source}-${searchItem.id}`)
            : undefined;
