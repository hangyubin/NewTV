...
function LivePageClient() {
  ...
  const handleChannelChange = async (channel: LiveChannel) => {
    ...
    if (
      ...
      watchRoom.changeLiveChannel(liveState);
    }
        ...
        <div className='flex items-center justify-center min-h-screen bg-transparent'>
          <div className='text-center max-w-md mx-auto px-6'>
            ...
            <div className='relative mb-8'>
              <div className='text-4xl transform hover:scale-105 transition-transform duration-300'>
                📺
              </div>
              ...
              <div className='absolute top-0 left-0 w-full h-full pointer-events-none'>
                ...
                <div
                  className='absolute top-4 right-4 w-1.5 h-1.5 bg-blue-500 rounded-full animate-bounce'
                  style={{ animationDelay: '0.5s' }}
                ></div>
                <div
                  className='absolute bottom-3 left-6 w-1 h-1 bg-blue-600 rounded-full animate-bounce'
